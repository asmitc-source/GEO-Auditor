# GEO Audit Report: Calendly

Generated: 2026-08-04T19:45:00.000Z
URL: https://calendly.com/

## AI Search Visibility Score: 73/100

| Check | Weight | Score | Why it matters |
| --- | ---: | ---: | --- |
| Entity clarity | 35% | 80/100 | AI engines need to understand what entity the site represents before they can confidently recommend or cite it. |
...
- **Page:** https://calendly.com/
- **Proof:** About page detected: false. Contact page detected: true.
...
### 2. Expose obvious About and Contact pages in the main navigation so crawlers can verify the entity.
...
- OK 200 https://calendly.com/ — Calendly - Free Online Appointment Scheduling Software (963 readable chars)
